...
namespace bumblebee.UI
{
    ...
    public class LineWeightTypesUi : DSDropDownBase
    {
        private const string OutputName = "Line Weight Type";
        private const string NoFamilyTypes = "No types were found.";
        public static LineWeightTypes cscTypes = new LineWeightTypes();

        public LineWeightTypesUi() : base(OutputName) { }

        [JsonConstructor]
        public LineWeightTypesUi(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base(OutputName, inPorts, outPorts) { }
        ...
        public override IEnumerable<AssociativeNode> BuildOutputAst(List<AssociativeNode> inputAstNodes)
        {
            ...
            var func = new Func<string, int>(LineWeightTypes.ByName);
