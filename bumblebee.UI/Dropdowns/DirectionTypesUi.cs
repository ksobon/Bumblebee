...
namespace bumblebee.UI
{
    ...
    public class DirectionTypesUi : DSDropDownBase
    {
        private const string OutputName = "Direction Type";
        private const string NoFamilyTypes = "No types were found.";
        public static DirectionTypes cscTypes = new DirectionTypes();

        public DirectionTypesUi() : base(OutputName) { }

        [JsonConstructor]
        public DirectionTypesUi(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base(OutputName, inPorts, outPorts) { }
        ...
        public override IEnumerable<AssociativeNode> BuildOutputAst(List<AssociativeNode> inputAstNodes)
        {
            ...
            var func = new Func<string, int>(DirectionTypes.ByName);
