...
namespace bumblebee.UI
{
    ...
    public class PieChartTypesUi : DSDropDownBase
    {
        private const string OutputName = "Pie Chart Type";
        private const string NoFamilyTypes = "No types were found.";
        public static PieChartTypes cscTypes = new PieChartTypes();

        public PieChartTypesUi() : base(OutputName) { }

        [JsonConstructor]
        public PieChartTypesUi(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base(OutputName, inPorts, outPorts) { }
        ...
        public override IEnumerable<AssociativeNode> BuildOutputAst(List<AssociativeNode> inputAstNodes)
        {
            ...
            var func = new Func<string, int>(PieChartTypes.ByName);
