...
namespace bumblebee.UI
{
    ...
    public class PatternTypesUi : DSDropDownBase
    {
        private const string OutputName = "Pattern Type";
        private const string NoFamilyTypes = "No types were found.";
        public static PatternTypes cscTypes = new PatternTypes();

        public PatternTypesUi() : base(OutputName) { }

        [JsonConstructor]
        public PatternTypesUi(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base(OutputName, inPorts, outPorts) { }
        ...
        public override IEnumerable<AssociativeNode> BuildOutputAst(List<AssociativeNode> inputAstNodes)
        {
            ...
            var func = new Func<string, int>(PatternTypes.ByName);
