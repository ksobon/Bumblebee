...
namespace bumblebee.UI
{
    ...
    public class LineTypesUi : DSDropDownBase
    {
        private const string OutputName = "Line Type";
        private const string NoFamilyTypes = "No types were found.";
        public static LineTypes cscTypes = new LineTypes();

        public LineTypesUi() : base(OutputName) { }

        [JsonConstructor]
        public LineTypesUi(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base(OutputName, inPorts, outPorts) { }
        ...
        public override IEnumerable<AssociativeNode> BuildOutputAst(List<AssociativeNode> inputAstNodes)
        {
            ...
            var func = new Func<string, int>(LineTypes.ByName);
